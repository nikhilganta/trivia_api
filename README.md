...
When a user plays the game they can play up to five questions of the chosen category. If there are fewer than five questions in a category, the game will end when there are no more questions in that category. 
...
The frontend uses Node Package Manager (NPM) to manage the dependencies
